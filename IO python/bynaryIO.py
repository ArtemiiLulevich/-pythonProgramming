# with open('IO samples\\binary', 'bw') as bin_file:
#     for i in range(17):
#         bin_file.write(bytes([i]))
#         # print(bytes(i))
#
# with open('IO samples\\binary', 'br') as binFile:
#     for b in binFile:
#         print(b)
...
with open('IO samples\\binary2', 'bw') as bin_file:
...
with open('IO samples\\binary2', 'br') as bin_file:
